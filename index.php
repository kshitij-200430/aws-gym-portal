...
<body>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/ban4.jpg);">
...
<hr>
  ...
  <div class="card">
    ...
    <div class="card-footer">
      ...
      class="font-weight-bolder">&#8377 800</span></p>
 ...
 <a href="#" class="btn" style="text-align: left; padding:0px;">
  <div class="card">  
    ...
    <div class="card-footer">
      ...
      class="font-weight-bolder">&#8377 200</span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="userRegistration.php">Book now</a>
    </div>
  </div>
 </a>
 <a href="#" class="btn" style="text-align: left; padding:0px;">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title"> AEROBICS/ZUMBA</h5>
      <p class="card-text text-dark">Join aerobics and zumba lessons <br>at profitness gym...
         </p>
    </div>
    <div class="card-footer">
      <p class="card-text d-inline">Price: <small><del>&#8377 1000
      </del></small> <span
      class="font-weight-bolder">&#8377 700</span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="userRegistration.php">Book now</a>
    </div>
  </div>
 </a>
</div>
...
<!-- service 2 start -->
  ...
  <div class="card">
    ...
    <div class="card-footer">
      <p class="card-text d-inline">Price: <small><del>&#8377 9000
      </del></small> <span
      class="font-weight-bolder">&#8377 500</span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="userRegistration.php">Book now</a>
    </div>
  </div>
 </a>
 <a href="#" class="btn" style="text-align: left; padding:0px;">
  <div class="card">
    ...
    <div class="card-footer">
      <p class="card-text d-inline">Price: <small><del>&#8377 6000
      </del></small> <span
      class="font-weight-bolder">&#8377 700</span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="userRegistration.php">Book now</a>
    </div>
  </div>
 ...
 <a href="#" class="btn" style="text-align: left; padding:0px;">
  <div class="card">
    ...
    <div class="card-footer">
      <p class="card-text d-inline">Price: <small><del>&#8377 400
      </del></small> <span
      class="font-weight-bolder">&#8377 600</span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="userRegistration.php">Book now</a>
    </div>
  </div>
 </a>
</div>
...
<hr>
    ...
    <p class="text-center col-11">
        ...
        <p> Profitness is a place where people go and work out.
            It is a gymnastics center that provides different types of physical training exercises 
            for members to practice to improve their healthy lifestyle. The gym was established 
            in 2006 and is located in Warje,Pune-411058</p>
    ...
    <p> Profitness offers a variety of services available for booking, such as cardio, yoga, Zumba, weight lifting, and endurance training.</p>
</div>
    ...
    <div class="container">
      ...
      <div class="row mt-5">
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/vihan.jpeg" class="img-fluid" style="border-radius: 100px;">
              <h4 class="card-title">Vihaan Deshmukh</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/ishita.jpeg" class="img-fluid" style="border-radius: 100px;">
              <h4 class="card-title">Ishita Kapoor</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/avt.jpeg" class="img-fluid" style="border-radius: 100px;">
              <h4 class="card-title">Rohan Khanna</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/priya.jpeg" class="img-fluid" style="border-radius: 100px;">
              <h4 class="card-title">Priya Gupta</h4>
              <p class="card-text">Im a trained expert in yoga exercises, i will help you improve your body through yoga .</p>
            </div>
          </div>
